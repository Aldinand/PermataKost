...
<head>
    ...
    <title>Reset Password - Permata Kost</title>
    ...
    <div class="auth-container">
        ...
        <div class="form-container">
            ...
            <?php else: ?>
                ...
                <form action="index.php?page=reset-password&token=<?php echo htmlspecialchars($token); ?>" method="post" class="auth-form">
                ...
                <div style="margin-top: 20px; text-align: center;">
                    <a href="index.php?page=forgot-password" class="auth-btn" style="display: inline-block;">Request New Reset Link</a>
                </div>
                <?php endif; ?>
            <?php endif; ?>
